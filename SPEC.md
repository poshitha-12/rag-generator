...
| FR6 (second line of defense) | `tests/test_rag_chain.py::test_prompt_refusal_backs_up_the_threshold` — context that clears the threshold but still doesn't answer, refused by the prompt instruction |
